...
import "@openzeppelin/contracts@4.7.0/token/ERC20/extensions/ERC20FlashMint.sol";

contract Love is ERC20, ERC20Burnable, Ownable, ERC20Permit, ERC20Votes, ERC20FlashMint {
    constructor() ERC20("Love", "<3") ERC20Permit("Love") {
